...
def create_database():
    ...
    cursor.execute("""
                ...
                category TEXT PRIMARY KEY,          -- e.g., 'honey', 'nuts', 'oil'
                prefer_organic BOOLEAN,
                max_price FLOAT,
                min_price FLOAT,
                updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    ...
    products = [
        ...
        (
            ...
            "honey",
            14.99,
            "Pure organic raw honey, unfiltered and cold-pressed",
            1,
        ),
        (
            2,
            ...
            "honey",
            12.99,
            "Natural wildflower honey from local beekeepers",
            0,
        ),
        (
            3,
            ...
            "honey",
            29.99,
            "Premium organic Manuka honey from New Zealand",
            1,
        ),
        (4, "Clover Honey", "honey", 8.99, "Classic clover honey, smooth and sweet", 0),
        (
            5,
            "Organic Buckwheat Honey",
            "honey",
            18.99,
            "Dark and robust organic buckwheat honey, antioxidant-rich",
            1,
        ),
        (
            6,
            ...
            "honey",
            15.99,
            "Light and floral orange blossom honey",
            0,
        ),
        (
            7,
            ...
            "honey",
            17.99,
            "Light and mild organic acacia honey, low glycemic index",
            1,
        ),
        (
            8,
            ...
            "honey",
            11.99,
            "Smooth creamed honey with spreadable texture",
            0,
        ),
        # --- Oils (4) ---
        (
            ...
            "oil",
            16.99,
            "Cold-pressed organic EVOO from Mediterranean olives",
            1,
        ),
        (
            10,
            ...
            "oil",
            12.49,
            "Refined coconut oil, great for high-heat cooking",
            0,
        ),
        (
            11,
            ...
            "oil",
            14.99,
            "Cold-pressed organic flaxseed oil, rich in omega-3",
            1,
        ),
        (
            12,
            ...
            "oil",
            18.99,
            "Cold-pressed avocado oil, high smoke point",
            0,
        ),
        # --- Nuts & Seeds (4) ---
        (
            ...
            "nuts",
            11.99,
            "Raw organic almonds, unsalted, non-GMO certified",
            1,
        ),
        ...
        (
            ...
            "seeds",
            8.49,
            "Organic black chia seeds, high in fiber and omega-3",
            1,
        ),
        (
            16,
            ...
            "nuts",
            13.99,
            "Premium mix of walnuts, pecans, almonds and Brazil nuts",
            0,
        ),
        # --- Grains & Cereals (4) ---
        (
            ...
            "grains",
            10.99,
            "Organic white quinoa, complete protein, gluten-free",
            1,
        ),
        (
            18,
            ...
            "grains",
            5.49,
            "Whole grain rolled oats, great for porridge and baking",
            0,
        ),
        (
            19,
            ...
            "grains",
            7.99,
            "Long-grain organic brown rice, naturally gluten-free",
            1,
        ),
        (
            20,
            ...
            "grains",
            6.99,
            "Traditional steel-cut oats, low GI, hearty texture",
            0,
        ),
        # --- Tea & Coffee (4) ---
        (
            ...
            "tea",
            12.99,
            "Japanese organic sencha green tea, 50 bags",
            1,
        ),
        (
            22,
            ...
            "tea",
            8.99,
            "Dried chamomile flowers, caffeine-free, soothing",
            0,
        ),
        (
            23,
            ...
            "coffee",
            16.99,
            "Single-origin organic Arabica, medium roast whole bean",
            1,
        ),
        (
            24,
            ...
            "coffee",
            14.49,
            "Bold dark roast espresso blend, ground",
            0,
        ),
        # --- Snacks (4) ---
        (
            ...
            "snacks",
            9.99,
            "Organic oat granola with honey, almonds and dried cranberries",
            1,
        ),
        (
            26,
            ...
            "snacks",
            4.49,
            "Lightly salted brown rice cakes, low calorie",
            0,
        ),
        (
            27,
            ...
            "snacks",
            7.99,
            "Unsweetened organic dried mango slices, no preservatives",
            1,
        ),
        (
            28,
            ...
            "snacks",
            8.49,
            "Classic trail mix with raisins, M&Ms, peanuts and sunflower seeds",
            0,
        ),
        ...
        (
            ...
            "dairy-alt",
            4.99,
            "Unsweetened organic almond milk, fortified with calcium",
            1,
        ),
        (
            30,
            ...
            "dairy-alt",
            4.49,
            "Barista-style oat milk, great for coffee",
            0,
        ),
        (
            31,
            ...
            "dairy-alt",
            3.99,
            "Full-fat organic coconut milk, great for curries",
            1,
        ),
